//******************************************************************************
// Element-wise Map F32 — shared implementation header
// Included by both el_map_f32.c (standalone kernel) and op_graph_2.c (graph kernel).
// All symbols are static to avoid multiple-definition issues across translation units.
//******************************************************************************
...
// ============================================================
// el_map_f32: element-wise MUL / ADD / SUB with broadcast
// ============================================================

static int el_map_f32(struct ggml_et_binary_params* params, void* env) {
