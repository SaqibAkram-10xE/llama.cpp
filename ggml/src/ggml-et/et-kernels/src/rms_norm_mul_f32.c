...
#define RMS_NORM_MUL_F32_FUNC rms_norm_mul_f32_impl
#else
#define RMS_NORM_MUL_F32_FUNC entry_point
#endif

int RMS_NORM_MUL_F32_FUNC(struct ggml_et_rms_norm_mul_params* params, void* env) {
